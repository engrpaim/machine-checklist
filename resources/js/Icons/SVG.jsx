const CrossIcon = ({ size = 24, color = "currentColor" }) => {
  return (
    <svg
...
const AddBoxIcon = ({ size = 24, color = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const ShieldSecurityIcon = ({ size = 24 , color = "#1f1f1f" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size}
...
const SearchIcon=({ size = 24 , color = "#1f1f1f" })=> {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size}
...
export { CrossIcon ,SettingsIcon ,SettingsIconMinimal,UserIcon,HomeIcon,BarChartIcon,BuildingIcon,InfoIcon,ArrowCircleIcon,AddBoxIcon,CloudUploadIcon,UploadCheckIcon,ShieldSecurityIcon,SearchIcon};
